...
class AtorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ator" do
    assert_difference("Ator.count") do
      post ators_url, params: { ator: { ano: @ator.ano, e-mail: @ator.e-mail, nome: @ator.nome } }
    end
  ...
  test "should update ator" do
    patch ator_url(@ator), params: { ator: { ano: @ator.ano, e-mail: @ator.e-mail, nome: @ator.nome } }
