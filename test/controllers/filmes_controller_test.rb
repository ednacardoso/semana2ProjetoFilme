...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference("Filme.count") do
      post filmes_url, params: { filme: { comentarios: @filme.comentarios, elenco: @filme.elenco, lancamento: @filme.lancamento, titulo: @filme.titulo } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { comentarios: @filme.comentarios, elenco: @filme.elenco, lancamento: @filme.lancamento, titulo: @filme.titulo } }
