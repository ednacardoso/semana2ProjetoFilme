...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference("Comentario.count") do
      post comentarios_url, params: { comentario: { comentario: @comentario.comentario, filme: @comentario.filme } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { comentario: @comentario.comentario, filme: @comentario.filme } }
